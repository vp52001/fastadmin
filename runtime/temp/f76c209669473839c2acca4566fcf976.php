<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\xampp\www\fastadmin\public/../application/index\view\index\index.html";i:1567156167;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Home'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Store'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Wxapp'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Services'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Download'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Demo'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Donation'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Forum'); ?></a></li>
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Docs'); ?></a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            </div>
        ...
        <section class="cta">
            <div class="cta-content">
                <div class="container">
                    ...
                    <a href="https://www.baidu.com" class="btn btn-outline btn-xl page-scroll"><?php echo __('Contribution'); ?></a>
                </div>
            </div>
        ...
        <footer>
            <div class="container">
                ...
                <p>&copy; 2017-2018 <a href="https://www.baidu.com" target="_blank">FastAdmin</a>. All Rights Reserved.</p>
                <ul class="list-inline">
                    <li>
                        <a href="https://www.baidu.com" target="_blank"><?php echo __('Gitee'); ?></a>
                    </li>
                    <li>
                        <a href="https://www.baidu.com" target="_blank"><?php echo __('Github'); ?></a>
                    </li>
                    <li>
                        <a href="https://www.baidu.com" target="_blank"><?php echo __('QQ group'); ?></a>
                    </li>
                </ul>
            </div>
        </footer>
